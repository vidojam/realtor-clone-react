                ...
                <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
                    <form>
                        ...
                        <div className="flex justify-between whitespace-nowrap text-sm sm-text-lg">
                            ...
                            <Link 
                            to="/sign-up" className="text-red-600 hover:text-red-800 transition duration-200 ease-in-out ml-1"
                            >
                                Register
                            </Link>
                            </p>
                            <p>
                            <Link 
                            to="/forgot-password" className="text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out ml-1"
                            >
                                Forgot password?
                            </Link>  
                            </p>
